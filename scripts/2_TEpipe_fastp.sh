...
# $2 = R2 FASTQ file
# $3 = Sample name
# $4 = Starting step (optional, default = 1)

# Set starting step (default to 1 if not provided)
START_STEP=${4:-1}
...
if [ $START_STEP -le 1 ]; then
    echo "=== Running Step 1: Quality Filtering & Adapter Trimming ==="
...
if [ $START_STEP -le 2 ]; then
    echo "=== Running Step 2: Contamination Removal ==="
...
if [ $START_STEP -le 3 ]; then
    echo "=== Running Step 3: Read Interleaving ==="
...
if [ $START_STEP -le 4 ]; then
    echo "=== Running Step 4: Transposome Analysis ==="
